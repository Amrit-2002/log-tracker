...
<x-app-layout>
    ...
    <div class="container mt-4">
        <h2 class="mb-4">Create New Task / Bug</h2>
        ...
        <form method="POST" action="{{ route('tasks.store') }}">
                ...
                <div class="col">
                    ...
                    <select class="form-select select2" name="client" required>
                        ...
                        @foreach($clients as $client)
                            <option value="{{ $client->name }}" {{ old('client') === $client->name ? 'selected' : '' }}>
                                {{ $client->name }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="task_bug_name" id="task_bug_name" value="{{ old('task_bug_name')}}" autocomplete="off" required>
            ...
            <div class="row mb-3">
                ...
                <div class="col">
                    ...
                    <input type="date" class="form-control" name="end_date" value="{{ old('end_date', now()->addWeek()->format('Y-m-d'))}}" required>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col">
                    <label for="dev_status" class="form-label">
                        Development Status <span class="text-danger">*</span>
                    </label>
                ...
                <div class="col">
                    <label for="unit_test_status" class="form-label">
                        Unit Testing Status <span class="text-danger">*</span>
                    </label>
                ...
                <div class="col">
                    <label for="staging_status" class="form-label">
                        Staging Status <span class="text-danger">*</span>
                    </label>
                ...
                <div class="col">
                    <label for="prod_status" class="form-label">
                        Production Status <span class="text-danger">*</span>
                    </label>
            ...
            <div class="mb-3">
                ...
                <input id="comment" type="hidden" name="comment" value="{{ old('comment') }}">
